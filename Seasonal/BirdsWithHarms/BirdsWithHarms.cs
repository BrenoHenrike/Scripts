...
public class BirdsWithHarms
{
    ...
    public void DoAll()
    {
        ...
        public void Chirpa()
        {
            if (Core.isCompletedBefore(8974))
                return;
        ...
        {
            if (Core.isCompletedBefore(8977))
                return;
        ...
        public void Goose()
        {
            if (Core.isCompletedBefore(8979))
                return;
        ...
        public void Hoo()
        {
            if (Core.isCompletedBefore(8984))
                return;
        ...
        public void Gandalf()
        {
            if (Core.isCompletedBefore(8987))
                return;
