            ...
            switch (req.Name)
            {
                ...
                case "Naval Guard's Tricorn + Locks":
                    ...
                    while (!Bot.ShouldExit && !Core.CheckInventory(req.Name, quant))
                    {
                        ...
                        Core.HuntMonster("aluteanursery", "Last Alutian", "Angler Antena", 5);
                        Core.EquipClass(ClassType.Farm);
                        Core.HuntMonster("aluteanursery", "Stagnant Water", "Stale Seawater", 30);
                        Core.HuntMonster("aluteanursery", "Bone Crustacean", "Pale Shell", 30);
                ...
                case "DeepSea Smol Wave":
                    Core.EquipClass(ClassType.Solo);
                    Core.HuntMonster("aluteanursery", "Last Alutian", req.Name, 1, false);
                    break;
            }
        }
    }
