...
public class DragonRoad
{
    ...
    public void StoryLine()
    {
        ...
        Core.Join("dragonroad");
        Bot.Sleep(10000);

        if (Bot.Map.Name.ToLower() == "dragonroad")
            Core.Logger("Requirements met");
        else
            Core.Logger("Requirements not met. No Upholder Badge found", messageBox: true, stopBot: true);
