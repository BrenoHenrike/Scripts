...
public class DeathPitArena
{
    ...
    public void DeathPitArenaSaga()
    {
        ...
        // Mingle
        Story.MapItemQuest(5133, "deathpit", 4484, 1);
        Story.MapItemQuest(5133, "deathpit", 4485, 1);
        Story.MapItemQuest(5133, "deathpit", 4486, 1);
        Story.MapItemQuest(5133, "deathpit", 4487, 1);
        Story.MapItemQuest(5133, "deathpit", 4488, 1);
        Story.MapItemQuest(5133, "deathpit", 4489, 1);
        Story.MapItemQuest(5133, "deathpit", 4490, 1);
        Story.MapItemQuest(5133, "deathpit", 4491, 1);
        // Those Dummies
