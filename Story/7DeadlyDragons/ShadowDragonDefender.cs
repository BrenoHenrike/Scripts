    ...
    public void ShadowDragonDefender()
    {
        ...
        if (!Core.CheckInventory("Manticore Cub Pet"))
        {
            ...
            if(!Bot.Quests.IsUnlocked(6908))
                Core.MapItemQuest(6907, "void", 6453, GetReward: false, hasFollowup: false);
            ...
            if(!Bot.Quests.IsUnlocked(6910))
                Core.MapItemQuest(6909, "void", 6454, GetReward: false, hasFollowup: false);
            ...
            if(!Bot.Quests.IsUnlocked(6914))
                Core.MapItemQuest(6913, "mysteriousegg", 6455, GetReward: false, hasFollowup: false);
