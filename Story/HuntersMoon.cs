...
public class HuntersMoon
{
    ...
    {        
        ...
        // Tree of Wisdom 6708
        Story.MapItemQuest(6708, "huntersmoon", 1);
        
        // Shards of Moonlight 6709
        Story.MapItemQuest(6709, "huntersmoon", 1, 6);
        
        // Moon-Struck 6710
        Story.KillQuest(6710, "huntersmoon", "Eclipsed One");
        
        // Offer the Skull 6711
        Story.MapItemQuest(6711, "huntersmoon", 1);
        ...
        Story.MapItemQuest(6802, "mooncursedlair", 1);
        ...
        Story.MapItemQuest(6805, "mooncursedlair", 1);
        ...
        // Check the Nest 6809
        Story.MapItemQuest(6809, "mooncursedlair", 1);
