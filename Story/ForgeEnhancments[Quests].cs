...
public class ForgeEnhancments
{
    ...
    {
        if (Bot.Config.Get<bool>("SkipOption") ? false : Bot.Config.Get<ForgeQuestCape>("ForgeQuestCape") == Bot.Config.Get<ForgeQuestCape>("ForgeQuestCape")) return;
    ...
    {
        if (Bot.Config.Get<bool>("SkipOption") ? false : Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestCape") == Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestCape")) return;
    ...
    {
        if (Bot.Config.Get<bool>("SkipOption") ? false : Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestCape") == Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestCape")) return;
        if (Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestWeapon") == ForgeQuestWeapon.ArcanasConcertoWIP || Bot.Config.Get<ForgeQuestWeapon>("ForgeQuestWeapon") == ForgeQuestWeapon.All)
        {
            // Arcana's Concerto   
