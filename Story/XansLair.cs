...
public class XansLair
{
    ...
    public void Volcano()
    {
        ...
        Core.KillQuest(QuestID: 1261, MapName: "volcano", MonsterName: "Magman");
    }
    ...
    public void AndesisQuests()
    {
        ...
        Core.MapItemQuest(QuestID: 1739, MapName: "xantown", MapItemID: 925);
    }

    public void ScoriasQuestsQuests()
    {
        Core.KillQuest(QuestID: 1740, MapName: "xantown", MonsterName: "Xan");
    }
    ...
    public void WarlicsQuests()
    {
        ...
        Core.MapItemQuest(QuestID: 2157, MapName: "xancave", MapItemID: 1222);
    }
}