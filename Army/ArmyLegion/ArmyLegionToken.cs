...
public class ArmyLegionToken
{
    ...
    public void Setup(Method Method, int quant = 25000)
    {
        ...
        switch (Method.ToString())
        {
            case "Dreadrock":
                ...
                // RunAggro(new[] { 4849 }, new[] { "Void Mercenary", "Fallen Hero", "Hollow Wraith", "Shadowknight", "Legion Sentinel" }, new[] { "Legion Token" }, "dreadrock", ClassType.Farm);
                break;
            ...
            case "Bright_Paragon_Pet":
                ...
                GetItem("brightfortress", "Skeletal Ice mage", "Legion Token", quant);
                break;
    ...
    private void RunAggro(bool Binky = false)
    => Army.RunGeneratedAggroMon(map, monNames, questIDs, classType, drops);
