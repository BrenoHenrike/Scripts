...
public class CoreFarms
{
    ...
    public void DwarfholdREP(int rank = 10)
    {
        ...
        {
            Core.EnsureAcceptmultiple(false, [320, 321]); //Warm and Furry 320, Shell Shock 321
    ...
    public void ElementalMasterREP(int rank = 10)
    {
        ...
        {
            Core.EnsureAcceptmultiple(false, [3050, 3298]);
            Core.EquipClass(ClassType.Farm);
            foreach (var element in elementalItems)
            {
    ...
    public void SandseaREP(int rank = 10)
    {
        ...
        // else
        {
            ...
            {
                Core.EnsureAcceptmultiple(false, [916, 917, 919, 921, 922]);
    ...
    public void SomniaREP(int rank = 10)
    {
        ...
        {
            Core.EnsureAcceptmultiple(false, [7665, 7666, 7669]);
    ...
    public void SwordhavenREP(int rank = 10)
    {
        ...
        // else
        {
            ...
            {
                Core.EnsureAcceptmultiple(false, [3065, 3066, 3067, 3070, 3085, 3086, 3087]);
    ...
    public void GetBoost(int itemID, string boostName, int BoostQuant, int quest, bool doOnce = false)
    {
        ...
        if (!doOnce) Core.TrashCan(["Fishing Bait", "Fishing Dynamite"]);
        Core.CancelRegisteredQuests();
    }
