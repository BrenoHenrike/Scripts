...
public class CurrentDailyGifts
{
    ...
    public void GetAllGifts(DailyGiftsMode mode)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            GetGift(AvailableUntil(30, 11), "citadelruins", "Grand Inquistor Murry", "Crimson Grand Inquistor Armor", "Grand Inquistor's Cape", "Crimson Grand Inquisitor's Bearded Headdress", "Crimson Grand Inquisitor's Collared Headdress", "Crimson Grand Inquisitor's Headdress", "Crimson Grand Inquisitor's Shaded Headdress");
