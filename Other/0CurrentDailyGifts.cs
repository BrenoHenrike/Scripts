...
public class CurrentDailyGifts
{
    ...
    public void GetAllGifts(DailyGiftsMode mode)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            GetGift(AvailableUntil(30, 09, 2022), "mythperception", "Boto", "Privateer's Cutlass", "Privateer's Dual Grenados", "Privateer's Grenado", "Privateer's Hair", "Privateer's Hand Cannon + Grenado", "Privateer's Locks");
            // //Pitiless Privateer Gear is in Trickster's Merge
            GetGift(AvailableUntil(30, 09, 2022), "mythperception", "Corpo-Seco", "Cangaceiro's Carabina", "Cangaceiro's Crossed Peixeira", "Cangaceiro's Dual Peixeira", "Cangaceiro's Peixeira");
            GetGift(AvailableUntil(30, 09, 2022), "mythperception", "Saci", "Cangaceira's Chapéu", "Cangaceira's Locks", "Cangaceiro Vitorioso", "Cangaceiro's Chapéu", "Cangaceiro's Chapéu + Beard", "Cangaceiro's Chapéu + Glasses");
            GetGift(AvailableUntil(30, 09, 2022), "hiddendepths", "Aquamancer", "Crystal Staff of the Deep");
            GetGift(AvailableUntil(30, 09, 2022), "blazebeard", "Pirate Captain", "Broken Split Blade of the Deep", "Split Blade of the Deep", "Split Blades of the Deep");
            Bot.Quests.UpdateQuest(6033);
            GetGift(AvailableUntil(30, 09, 2022), "celestialarenad", "Queen of Hope", "Arch Lich", "Arch Lich's Blessed Scrolls", "Arch Lich's Hood", "Arch Lich's Orb", "Arch Lich's Runes", "Arch Lich's Scrolls", "Arch Lich's Spear", "Arch Lich's Spears");
            GetGift(AvailableUntil(30, 09, 2022), "deadmoor", "Nightmare", "Huasa's Cabello Elegante", "Huasa's Cabello Festejo", "Huasa's Cabello Oscuro", "Huasa's Rostro Elegante", "Huaso's Atuendo Elegante", "Huaso's Atuendo Escabroso", "Huaso's Atuendo Festejo", "Huaso's Atuendo Oscuro", "Huaso's Cabello Elegante", "Huaso's Cabello Festejo", "Huaso's Cabello Oscuro", "Huaso's Rostro Elegante");
            GetGift(AvailableUntil(30, 09, 2022), "blazebeard", "Pirate Captain", "Pirate Captain Twig");
            GetGift(AvailableUntil(30, 09, 2022), "hiddendepths", "Aqua Familiar", "Dagger of the Depths", "Daggers of the Depths", "Sword of the Depths", "Swords of the Depths");
            ...
            GetGift(AvailableUntil(14, 10, 2022), "battleontown", "Zard", "Chibi Plushie Teka", "Chibi Teka Pet", "GIANT Haunted Teka Plushie", "Haunted Teka Plushie", "Teka's Birthday Hat");
            GetGift(AvailableUntil(14, 10, 2022), "lowtide", "Spectral Jellyfish", "Lance of the Depths", "Spear of the Depths", "Staff of the Depths", "Trident of the Depths");
            ...
            GetGift(AvailableUntil(25, 11, 2022), "mystcroftforest", "Barghest", "Skullbound Kamas", "Skullbound Kusarigama", "Skullbound Kama");
            GetGift(AvailableUntil(25, 11, 2022), "evilwardage", "Dilligas", "Oversoul Black Dragon Pet", "Oversoul Black Dragon Battlepet");
            ...
            GetGift(AvailableUntil(25, 11, 2022), "crescentmoon", "Royce", "Headless Horseman", "Ghost Eta");
