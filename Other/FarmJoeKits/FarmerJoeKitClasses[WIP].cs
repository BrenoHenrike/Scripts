...
public class FarmerJoeKitClasses
{
    ...
    public GlacialBerserker GlacialBerserker = new();
    public StoneCrusher StoneCrusher = new();
    public ArchPaladin ArchPaladin = new();
    public DragonShinobi DragonShinobi = new();
