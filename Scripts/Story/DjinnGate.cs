...
public class DjinnGateStory
{
    ...
    public void DjinnGate()
    {
        ...
        if(!Bot.Quests.IsUnlocked(6160))
            Core.MapItemQuest(6159, "djinngate", 5571, 5, false, hasFollowup: false);
